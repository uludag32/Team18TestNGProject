...
public class US20_AC1_TC02 {
    ...
    public void AC1_TC02() {
        ...
        us20_spendinggoodHomePage.codeBox.sendKeys("123-986");
        ...
        us20_spendinggoodHomePage.discountTypeBox.sendKeys(Keys.ARROW_DOWN);
        us20_spendinggoodHomePage.discountTypeBox.click(); //Fixed product discount
        ReusableMethods.waitFor(3);
